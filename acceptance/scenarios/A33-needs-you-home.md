...
Keep private screenshots of the App Home states, source reply receipt, action-page confirmation, and redacted local state evidence under the run directory. Include the RAZR Plus 2023 narrow-screen screenshots for Active, Snoozed, and Done, identifying whether they came from the live configured app or Builder/mobile preview. Record the SHA, exact selected config, and each observed state transition.
